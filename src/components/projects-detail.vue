<template>
  ...
  <div v-if="loading" class="page-loader flex flex-col">
    ...
    <div v-if="project.image3" class="relative w-[33%] h-[100px] max-[920px]:w-[30%] max-[420px]:h-[50px] my-[20px]">
